...
.page table .unit {
    background: rgba(221, 221, 221, 0.178)
}
            ...
            <main>
                <div class="row contacts">
                    ...
                    <div class="col invoice-details">
                        <h1 class="invoice-id">CHALAN {{$sale->bill_id}}</h1>
                        <div class="date"><h3></strong></b>Date of Invoice: {{date('d M-Y', strtotime($sale->sales_date))}}</h3>
