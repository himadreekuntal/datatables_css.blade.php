...
td, th {
  ...
  font-family: arial, sans-serif;
    ...
    <body>
        ...
        <h4 style="text-align:center;"> Sales Report of {{ $name }} from {{ date('d-m-Y', strtotime($fromDate))}} to {{ date('d-m-Y', strtotime($toDate))}}</h4>
        <table>
                <thead>
                    <tr>
                        <th>Sales Id</th>
                ...
                @foreach($sale as $sale)
                    ...
                    <td>{{ $sale-> rate }} ({{$sale-> discount}}) </td>

                            <td>Tk. {{number_format($sale->total, 2)}} </td>
                    ...
                    <td></td>
                    <td style="text-align:left;">Total : {{number_format($total, 2)}} </td>
