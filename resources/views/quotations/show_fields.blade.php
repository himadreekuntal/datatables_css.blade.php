...
<div id="invoice">
    ...
    <div class="toolbar hidden-print">
        <div class="text-right">
            <a href="{{route('quotationprint', ['quotation_id' => $quotation->id])}}" class=" btnprn btn btn-info"><i class="fa fa-print"></i> Print</a>
            <a href="{{route('quotationpdf', ['quotation_id' => $quotation->id])}}" class="btn btn-info"></i> Export as PDF</a>
        </div>
        <hr>
    </div>
