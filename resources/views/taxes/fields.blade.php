...
<div class="table">
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="name form-control" name="names[]" value="{{ old('name') }}">
            </td>

            <td>
                <input type="text" class="amount form-control" name="amounts[]" value="{{ old('amount') }}">
            </td>

            <td>
                <input type="text" class="tax_percentage form-control" name="tax_percentages[]" value="{{ old('tax_percentage') }}">
            </td>
