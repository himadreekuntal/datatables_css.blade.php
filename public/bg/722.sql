...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2021 at 06:52 AM
...
CREATE TABLE `tenders` (
  ...
  `etender_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `procuring_entity` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tender_status` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bg_status` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pg_status` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
